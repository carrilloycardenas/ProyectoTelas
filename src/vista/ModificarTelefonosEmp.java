 ...
 * @author luis-
 */
public class ModificarTelefonosEmp extends javax.swing.JFrame {

    /**
     * Creates new form ventanaInicio
     */
    public ModificarTelefonosEmp() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarTelefonosEmp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarTelefonosEmp().setVisible(true);
            }
        });
    }
