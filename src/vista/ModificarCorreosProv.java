 ...
 * @author luis-
 */
public class ModificarCorreosProv extends javax.swing.JFrame {

    /**
     * Creates new form ventanaInicio
     */
    public ModificarCorreosProv() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarCorreosProv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarCorreosProv().setVisible(true);
            }
        });
    }
