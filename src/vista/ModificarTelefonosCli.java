 ...
 * @author luis-
 */
public class ModificarTelefonosCli extends javax.swing.JFrame {

    /**
     * Creates new form ventanaInicio
     */
    public ModificarTelefonosCli() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarTelefonosCli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarTelefonosCli().setVisible(true);
            }
        });
    }
