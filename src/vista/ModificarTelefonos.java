 ...
 * @author luis-
 */
public class ModificarTelefonos extends javax.swing.JFrame {

    /**
     * Creates new form ventanaInicio
     */
    public ModificarTelefonos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarTelefonos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarTelefonos().setVisible(true);
            }
        });
    }
