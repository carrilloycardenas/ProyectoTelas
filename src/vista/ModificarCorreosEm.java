 ...
 * @author luis-
 */
public class ModificarCorreosEm extends javax.swing.JFrame {

    /**
     * Creates new form ventanaInicio
     */
    public ModificarCorreosEm() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarCorreosEm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarCorreosEm().setVisible(true);
            }
        });
    }
