 ...
 * @author luis-
 */
public class ModificarTelefonosProv extends javax.swing.JFrame {

    /**
     * Creates new form ventanaInicio
     */
    public ModificarTelefonosProv() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel20.add(btnProveedores, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 200, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarTelefonosProv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarTelefonosProv().setVisible(true);
            }
        });
    }
